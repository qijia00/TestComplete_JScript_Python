...
def ECS_V3_4038(SSUIP):
    ...
    while i <= 6:
        ...
        # When click the [ECU Tools] button, the remove ECU from site Confirmation popup window maybe displayed
        # In order to resolve this problem, we will use arrow down button to make the selection instead using click
